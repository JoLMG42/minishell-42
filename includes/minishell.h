...
/*   Updated: 2024/07/18 21:38:02 by juliensarda      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		**erase_split_parse_block(char **split, t_shell *shell, char *s,
				int *i);
...
int			cut_parse_block_loop_1(char **split, int i, t_data *datas,
				t_shell *shell);
int			ccut_parse_block_loop_1(char **split, int i, t_data *datas,
				t_shell *shell);
int			cut_parse_block_loop_2(char **split, int i, t_data *datas,
				t_shell *shell);
int			ccut_parse_block_loop_2(char **split, int i, t_data *datas,
				t_shell *shell);
